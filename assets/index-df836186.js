...
`+PR(t.getShaderSource(e),a)}else return i}function OR(t,e){const n=LR(e);return`vec4 ${t}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function DR(t,e){let n;switch(e){case Ob:n="Linear";break;case Db:n="Reinhard";break;case Nb:n="OptimizedCineon";break;case Ib:n="ACESFilmic";break;case kb:n="AgX";break;case Ub:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}function NR(t){return[t.extensionDerivatives||t.envMapCubeUVHeight||t.bumpMap||t.normalMapTangentSpace||t.clearcoatNormalMap||t.flatShading||t.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(t.extensionFragDepth||t.logarithmicDepthBuffer)&&t.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",t.extensionDrawBuffers&&t.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(t.extensionShaderTextureLOD||t.envMap||t.transmission)&&t.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Vo).join(`
...
#define LOW_PRECISION`),e}function VR(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Ky?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===ab?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===Cr&&(e="SHADOWMAP_TYPE_VSM"),e}function WR(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case la:case ua:e="ENVMAP_TYPE_CUBE";break;case Ju:e="ENVMAP_TYPE_CUBE_UV";break}return e}function jR(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case ua:e="ENVMAP_MODE_REFRACTION";break}return e}function $R(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case np:e="ENVMAP_BLENDING_MULTIPLY";break;case Pb:e="ENVMAP_BLENDING_MIX";break;case Lb:e="ENVMAP_BLENDING_ADD";break}return e}function XR(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:r,maxMip:n}}function qR(t,e,n,r){const i=t.getContext(),o=n.defines;let a=n.vertexShader,s=n.fragmentShader;const l=VR(n),u=WR(n),c=jR(n),d=$R(n),h=XR(n),p=n.isWebGL2?"":NR(n),g=IR(n),v=UR(o),m=i.createProgram();let f,_,y=n.glslVersion?"#version "+n.glslVersion+`
...
`}var EL=Ep.exports,bp={exports:{}};const bL=xa;bp.exports=wL;bp.exports.generateCreateDragForceFunctionBody=nS;function wL(t){let e=nS(t);return new Function("options",e)}function nS(t){return`
...
`}var TL=bp.exports,wp={exports:{}};const AL=xa;wp.exports=CL;wp.exports.generateCreateSpringForceFunctionBody=rS;function CL(t){let e=rS(t);return new Function("options","random",e)}function rS(t){let e=AL(t);return`
...
`}var RL=wp.exports,Tp={exports:{}};const PL=xa;Tp.exports=LL;Tp.exports.generateIntegratorFunctionBody=iS;function LL(t){let e=iS(t);return new Function("bodies","timeStep","adaptiveTimeStepWeight",e)}function iS(t){let e=PL(t);return`
